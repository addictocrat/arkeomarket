  ...
  const onSubmit = useCallback(
    async (data: FormData) => {
      try {
        ...
        setError('Eposta veya şifreniz hatalı. Tekrar deneyin veya şifrenizi yenileyin.')
      }
    },
    [login, router],
  )
    ...
    <form className="" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="flex flex-col gap-8">
        <FormItem>
          ...
          <Input id="email" type="email" {...register('email', { required: 'Eposta giriniz.' })} />
        ...
        <div className="text-primary/70 mb-6 prose prose-a:hover:text-primary dark:prose-invert">
          <p>
            ...
            <Link href={`/recover-password${allParams}`}>Buraya tıklayın</Link>
          </p>
        </div>
      </div>
